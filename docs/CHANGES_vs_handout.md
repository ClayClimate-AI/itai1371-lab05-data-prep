...
was kept: the only backup (a scratch copy) was taken after the
...
Cell 5   Task 1  filled in
         ...
         │   verified 2026-09-20: handout line leaves 177 NaN on pandas 3.0.6.
...
Cell 8   Task 2  filled in
         ...
         │   missing values and says the dataset has missing values; Task 2 just doesn't spell out this step.
...
Both deviations (inplace, Embarked) are discussed in the reflective journal.
